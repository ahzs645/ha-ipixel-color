...
`;function at(c){if(!c||c==="#111"||c==="#000")return[17,17,17];if(c==="#050505")return[5,5,5];let e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(c);return e?[parseInt(e[1],16),parseInt(e[2],16),parseInt(e[3],16)]:[17,17,17]}function W(c,e,t){let s=0,i=0,o=0,n=Math.floor(c*6),r=c*6-n,a=t*(1-e),l=t*(1-r*e),d=t*(1-(1-r)*e);switch(n%6){case 0:s=t,i=d,o=a;break;case 1:s=l,i=t,o=a;break;case 2:s=a,i=t,o=d;break;case 3:s=a,i=l,o=t;break;case 4:s=d,i=a,o=t;break;case 5:s=t,i=a,o=l;break}return[s*255,i*255,o*255]}var rt=class{constructor(e){this.renderer=e}init(e,t){let{width:s,height:i}=this.renderer;switch(e){case"scroll_ltr":case"scroll_rtl":t.offset=0;break;case"blink":t.visible=!0;break;case"snow":case"breeze":t.phases=[];for(let o=0;o<s*i;o++)t.phases.push(Math.random()*Math.PI*2);break;case"laser":t.position=0;break;case"fade":t.opacity=0,t.direction=1;break;case"typewriter":t.charIndex=0,t.cursorVisible=!0;break;case"bounce":t.offset=0,t.direction=1;break;case"sparkle":t.sparkles=[];for(let o=0;o<Math.floor(s*i*.1);o++)t.sparkles.push({x:Math.floor(Math.random()*s),y:Math.floor(Math.random()*i),brightness:Math.random(),speed:.05+Math.random()*.1});break}}step(e,t){let{width:s,extendedWidth:i}=this.renderer;switch(e){case"scroll_ltr":t.offset-=1,t.offset<=-(i||s)&&(t.offset=s);break;case"scroll_rtl":t.offset+=1,t.offset>=(i||s)&&(t.offset=-s);break;case"blink":t.visible=!t.visible;break;case"laser":t.position=(t.position+1)%s;break;case"fade":t.opacity+=t.direction*.05,t.opacity>=1?(t.opacity=1,t.direction=-1):t.opacity<=0&&(t.opacity=0,t.direction=1);break;case"typewriter":t.tick%3===0&&t.charIndex++,t.cursorVisible=t.tick%10<5;break;case"bounce":{t.offset+=t.direction;let o=Math.max(0,(i||s)-s);t.offset>=o?(t.offset=o,t.direction=-1):t.offset<=0&&(t.offset=0,t.direction=1);break}case"sparkle":{let o=t.sparkles;for(let n of o)n.brightness+=n.speed,n.brightness>1&&(n.brightness=0,n.x=Math.floor(Math.random()*s),n.y=Math.floor(Math.random()*this.renderer.height));break}}}render(e,t,s,i,o){let{width:n,height:r}=this.renderer,a=i||s||[],l=s||[],d=o||n;for(let f=0;f<r;f++)for(let h=0;h<n;h++){let p,m=h;if(e==="scroll_ltr"||e==="scroll_rtl"||e==="bounce"){for(m=h-(t.offset||0);m<0;)m+=d;for(;m>=d;)m-=d;p=a[f*d+m]||"#111"}else if(e==="typewriter"){let v=(t.charIndex||0)*6;h<v?p=l[f*n+h]||"#111":h===v&&t.cursorVisible?p="#ffffff":p="#111"}else p=l[f*n+h]||"#111";let[u,b,g]=at(p);if(u>20||b>20||g>20)switch(e){case"blink":t.visible||(u=b=g=17);break;case"snow":{let _=t.phases,v=_?.[f*n+h]||0,y=t.tick||0,E=.3+.7*Math.abs(Math.sin(v+y*.3));u*=E,b*=E,g*=E;break}case"breeze":{let _=t.phases,v=_?.[f*n+h]||0,y=t.tick||0,E=.4+.6*Math.abs(Math.sin(v+y*.15+h*.2));u*=E,b*=E,g*=E;break}case"laser":{let _=t.position||0,y=Math.abs(h-_)<3?1:.3;u*=y,b*=y,g*=y;break}case"fade":{let _=t.opacity||1;u*=_,b*=_,g*=_;break}}if(e==="sparkle"&&t.sparkles){let _=t.sparkles;for(let v of _)if(v.x===h&&v.y===f){let y=Math.sin(v.brightness*Math.PI);u=Math.min(255,u+y*200),b=Math.min(255,b+y*200),g=Math.min(255,g+y*200)}}this.renderer.setPixel(h,f,[u,b,g])}}},lt=class{constructor(e){this.renderer=e}init(e,t){let{width:s,height:i}=this.renderer;switch(e){case"rainbow":t.position=0;break;case"matrix":{let o=[[0,255,0],[0,255,255],[255,0,255]];t.colorMode=o[Math.floor(Math.random()*o.length)],t.buffer=[];for(let n=0;n<i;n++)t.buffer.push(Array(s).fill(null).map(()=>[0,0,0]));break}case"plasma":case"gradient":t.time=0;break;case"fire":t.heat=[];for(let o=0;o<s*i;o++)t.heat.push(0);t.palette=this._createFirePalette();break;case"water":t.current=[],t.previous=[];for(let o=0;o<s*i;o++)t.current.push(0),t.previous.push(0);t.damping=.95;break;case"stars":{t.stars=[];let o=Math.floor(s*i*.15);for(let n=0;n<o;n++)t.stars.push({x:Math.floor(Math.random()*s),y:Math.floor(Math.random()*i),brightness:Math.random(),speed:.02+Math.random()*.05,phase:Math.random()*Math.PI*2});break}case"confetti":t.particles=[];for(let o=0;o<20;o++)t.particles.push(this._createConfettiParticle(s,i,!0));break;case"plasma_wave":case"radial_pulse":case"hypnotic":case"aurora":t.time=0;break;case"lava":t.time=0,t.noise=[];for(let o=0;o<s*i;o++)t.noise.push(Math.random()*Math.PI*2);break}}step(e,t){let{width:s,height:i}=this.renderer;switch(e){case"rainbow":t.position=(t.position+.01)%1;break;case"matrix":this._stepMatrix(t,s,i);break;case"plasma":case"gradient":t.time=(t.time||0)+.05;break;case"fire":this._stepFire(t,s,i);break;case"water":this._stepWater(t,s,i);break;case"stars":{let o=t.stars;for(let n of o)n.phase+=n.speed;break}case"confetti":{let o=t.particles;for(let n=0;n<o.length;n++){let r=o[n];r.y+=r.speed,r.x+=r.drift,r.rotation+=r.rotationSpeed,r.y>i&&(o[n]=this._createConfettiParticle(s,i,!1))}break}case"plasma_wave":case"radial_pulse":case"hypnotic":case"lava":case"aurora":t.time=(t.time||0)+.03;break}}render(e,t){switch(e){case"rainbow":this._renderRainbow(t);break;case"matrix":this._renderMatrix(t);break;case"plasma":this._renderPlasma(t);break;case"gradient":this._renderGradient(t);break;case"fire":this._renderFire(t);break;case"water":this._renderWater(t);break;case"stars":this._renderStars(t);break;case"confetti":this._renderConfetti(t);break;case"plasma_wave":this._renderPlasmaWave(t);break;case"radial_pulse":this._renderRadialPulse(t);break;case"hypnotic":this._renderHypnotic(t);break;case"lava":this._renderLava(t);break;case"aurora":this._renderAurora(t);break}}_renderRainbow(e){let{width:t,height:s}=this.renderer,i=e.position||0;for(let o=0;o<t;o++){let n=(i+o/t)%1,[r,a,l]=W(n,1,.6);for(let d=0;d<s;d++)this.renderer.setPixel(o,d,[r,a,l])}}_stepMatrix(e,t,s){let i=e.buffer,o=e.colorMode,n=.15;i.pop();let r=i[0].map(([a,l,d])=>[a*(1-n),l*(1-n),d*(1-n)]);i.unshift(JSON.parse(JSON.stringify(r)));for(let a=0;a<t;a++)Math.random()<.08&&(i[0][a]=[Math.floor(Math.random()*o[0]),Math.floor(Math.random()*o[1]),Math.floor(Math.random()*o[2])])}_renderMatrix(e){var t;let{width:s,height:i}=this.renderer,o=e.buffer;if(o)for(let n=0;n<i;n++)for(let r=0;r<s;r++){let[a,l,d]=((t=o[n])==null?void 0:t[r])||[0,0,0];this.renderer.setPixel(r,n,[a,l,d])}}_renderPlasma(e){let{width:t,height:s}=this.renderer,i=e.time||0,o=t/2,n=s/2;for(let r=0;r<t;r++)for(let a=0;a<s;a++){let l=r-o,d=a-n,f=Math.sqrt(l*l+d*d),h=Math.sin(r/8+i),p=Math.sin(a/6+i*.8),m=Math.sin(f/6-i*1.2),u=Math.sin((r+a)/10+i*.5),b=(h+p+m+u+4)/8,g=Math.sin(b*Math.PI*2)*.5+.5,x=Math.sin(b*Math.PI*2+2)*.5+.5,_=Math.sin(b*Math.PI*2+4)*.5+.5;this.renderer.setPixel(r,a,[g*255,x*255,_*255])}}_renderGradient(e){let{width:t,height:s}=this.renderer,o=(e.time||0)*10;for(let n=0;n<t;n++)for(let r=0;r<s;r++){let a=(Math.sin((n+o)*.05)*.5+.5)*255,l=(Math.cos((r+o)*.05)*.5+.5)*255,d=(Math.sin((n+r+o)*.03)*.5+.5)*255;this.renderer.setPixel(n,r,[a,l,d])}}_createFirePalette(){let e=[];for(let t=0;t<256;t++){let s,i,o;t<64?(s=t*4,i=0,o=0):t<128?(s=255,i=(t-64)*4,o=0):t<192?(s=255,i=255,o=(t-128)*4):(s=255,i=255,o=255),e.push([s,i,o])}return e}_stepFire(e,t,s){let i=e.heat;for(let o=0;o<t*s;o++)i[o]=Math.max(0,i[o]-Math.random()*10);for(let o=0;o<s-1;o++)for(let n=0;n<t;n++){let r=o*t+n,a=(o+1)*t+n,l=o*t+Math.max(0,n-1),d=o*t+Math.min(t-1,n+1);i[r]=(i[a]+i[l]+i[d])/3.05}for(let o=0;o<t;o++)Math.random()<.6&&(i[(s-1)*t+o]=180+Math.random()*75)}_renderFire(e){let{width:t,height:s}=this.renderer,i=e.heat,o=e.palette;for(let n=0;n<s;n++)for(let r=0;r<t;r++){let a=n*t+r,l=Math.floor(Math.min(255,i[a])),[d,f,h]=o[l];this.renderer.setPixel(r,n,[d,f,h])}}_stepWater(e,t,s){let i=e.current,o=e.previous,n=e.damping,r=[...o];for(let a=0;a<i.length;a++)o[a]=i[a];for(let a=1;a<s-1;a++)for(let l=1;l<t-1;l++){let d=a*t+l;i[d]=(r[(a-1)*t+l]+r[(a+1)*t+l]+r[a*t+(l-1)]+r[a*t+(l+1)])/2-i[d],i[d]*=n}if(Math.random()<.1){let a=Math.floor(Math.random()*(t-2))+1,l=Math.floor(Math.random()*(s-2))+1;i[l*t+a]=255}}_renderWater(e){let{width:t,height:s}=this.renderer,i=e.current;for(let o=0;o<s;o++)for(let n=0;n<t;n++){let r=o*t+n,a=Math.abs(i[r]),l=Math.min(255,a*2),d=l>200?l:0,f=l>150?l*.8:l*.3,h=Math.min(255,50+l);this.renderer.setPixel(n,o,[d,f,h])}}_renderStars(e){let{width:t,height:s}=this.renderer;for(let o=0;o<s;o++)for(let n=0;n<t;n++)this.renderer.setPixel(n,o,[5,5,15]);let i=e.stars;for(let o of i){let n=(Math.sin(o.phase)*.5+.5)*255,r=Math.floor(o.x),a=Math.floor(o.y);r>=0&&r<t&&a>=0&&a<s&&this.renderer.setPixel(r,a,[n,n,n*.9])}}_createConfettiParticle(e,t,s){let i=[[255,0,0],[0,255,0],[0,0,255],[255,255,0],[255,0,255],[0,255,255],[255,128,0],[255,192,203]];return{x:Math.random()*e,y:s?Math.random()*t:-2,speed:.2+Math.random()*.3,drift:(Math.random()-.5)*.3,color:i[Math.floor(Math.random()*i.length)],size:1+Math.random(),rotation:Math.random()*Math.PI*2,rotationSpeed:(Math.random()-.5)*.2}}_renderConfetti(e){let{width:t,height:s}=this.renderer;for(let o=0;o<s;o++)for(let n=0;n<t;n++)this.renderer.setPixel(n,o,[10,10,10]);let i=e.particles;for(let o of i){let n=Math.floor(o.x),r=Math.floor(o.y);if(n>=0&&n<t&&r>=0&&r<s){let a=Math.abs(Math.sin(o.rotation))*.5+.5,[l,d,f]=o.color;this.renderer.setPixel(n,r,[l*a,d*a,f*a])}}}_renderPlasmaWave(e){let{width:t,height:s}=this.renderer,i=e.time||0;for(let o=0;o<t;o++)for(let n=0;n<s;n++){let r=o/t,a=n/s,l=Math.sin(r*10+i)+Math.sin(a*10+i)+Math.sin((r+a)*10+i)+Math.sin(Math.sqrt((r-.5)**2+(a-.5)**2)*20-i*2),d=Math.sin(l*Math.PI)*.5+.5,f=Math.sin(l*Math.PI+2.094)*.5+.5,h=Math.sin(l*Math.PI+4.188)*.5+.5;this.renderer.setPixel(o,n,[d*255,f*255,h*255])}}_renderRadialPulse(e){let{width:t,height:s}=this.renderer,i=e.time||0,o=t/2,n=s/2;for(let r=0;r<t;r++)for(let a=0;a<s;a++){let l=r-o,d=a-n,f=Math.sqrt(l*l+d*d),h=Math.sin(f*.8-i*3)*.5+.5,p=Math.sin(i*2)*.3+.7,m=(f/20+i*.5)%1,[u,b,g]=W(m,.8,h*p);this.renderer.setPixel(r,a,[u,b,g])}}_renderHypnotic(e){let{width:t,height:s}=this.renderer,i=e.time||0,o=t/2,n=s/2;for(let r=0;r<t;r++)for(let a=0;a<s;a++){let l=r-o,d=a-n,f=Math.sqrt(l*l+d*d),h=Math.atan2(d,l),m=Math.sin(h*4+f*.5-i*2)*.5+.5,u=m*(Math.sin(i)*.5+.5),b=m*(Math.sin(i+2.094)*.5+.5),g=m*(Math.sin(i+4.188)*.5+.5);this.renderer.setPixel(r,a,[u*255,b*255,g*255])}}_renderLava(e){let{width:t,height:s}=this.renderer,i=e.time||0;for(let o=0;o<t;o++)for(let n=0;n<s;n++){let r=o/t,a=n/s,l=Math.sin(r*8+i*.7)*Math.cos(a*6+i*.5),d=Math.sin(r*12-i*.3)*Math.sin(a*10+i*.8),f=Math.cos((r+a)*5+i),h=(l+d+f+3)/6,p,m,u;h<.3?(p=h*3*100,m=0,u=0):h<.6?(p=100+(h-.3)*3*155,m=(h-.3)*3*100,u=0):(p=255,m=100+(h-.6)*2.5*155,u=(h-.6)*2.5*100),this.renderer.setPixel(o,n,[p,m,u])}}_renderAurora(e){let{width:t,height:s}=this.renderer,i=e.time||0;for(let o=0;o<t;o++)for(let n=0;n<s;n++){let r=o/t,a=n/s,l=Math.sin(r*6+i)*.3,d=Math.sin(r*4-i*.7)*.2,f=Math.sin(r*8+i*1.3)*.15,h=.5+l+d+f,p=Math.abs(a-h),m=Math.max(0,1-p*4),u=Math.pow(m,1.5),b=Math.sin(r*3+i*.5),g=u*(.2+b*.3)*255,x=u*(.8+Math.sin(i+r)*.2)*255,_=u*(.6+b*.4)*255,v=Math.sin(o*127.1+n*311.7)*.5+.5,y=Math.sin(i*3+o+n)*.5+.5;if(v>.98&&m<.3){let E=y*180;g=Math.max(g,E),x=Math.max(x,E),_=Math.max(_,E*.9)}this.renderer.setPixel(o,n,[g,x,_])}}},ct=class{constructor(e){this.renderer=e}init(e,t){switch(e){case"color_cycle":t.hue=0;break;case"rainbow_text":t.offset=0;break;case"neon":t.glowIntensity=0,t.direction=1,t.baseColor=t.fgColor||"#ff00ff";break}}step(e,t){switch(e){case"color_cycle":t.hue=(t.hue+.01)%1;break;case"rainbow_text":t.offset=(t.offset+.02)%1;break;case"neon":t.glowIntensity+=t.direction*.05,t.glowIntensity>=1?(t.glowIntensity=1,t.direction=-1):t.glowIntensity<=.3&&(t.glowIntensity=.3,t.direction=1);break}}render(e,t,s){let{width:i,height:o}=this.renderer,n=s||[];for(let r=0;r<o;r++)for(let a=0;a<i;a++){let l=n[r*i+a]||"#111",[d,f,h]=at(l);if(d>20||f>20||h>20)switch(e){case"color_cycle":{let[m,u,b]=W(t.hue,1,.8),g=(d+f+h)/(3*255);d=m*g,f=u*g,h=b*g;break}case"rainbow_text":{let m=(t.offset+a/i)%1,[u,b,g]=W(m,1,.8),x=(d+f+h)/(3*255);d=u*x,f=b*x,h=g*x;break}case"neon":{let m=at(t.baseColor||"#ff00ff"),u=t.glowIntensity||.5;if(d=m[0]*u,f=m[1]*u,h=m[2]*u,u>.8){let b=(u-.8)*5;d=d+(255-d)*b*.3,f=f+(255-f)*b*.3,h=h+(255-h)*b*.3}break}}this.renderer.setPixel(a,r,[d,f,h])}}},X={TEXT:"text",AMBIENT:"ambient",COLOR:"color"},M={fixed:{category:"text",name:"Fixed",description:"Static display"},scroll_ltr:{category:"text",name:"Scroll Left",description:"Text scrolls left to right"},scroll_rtl:{category:"text",name:"Scroll Right",description:"Text scrolls right to left"},blink:{category:"text",name:"Blink",description:"Text blinks on/off"},breeze:{category:"text",name:"Breeze",description:"Gentle wave brightness"},snow:{category:"text",name:"Snow",description:"Sparkle effect"},laser:{category:"text",name:"Laser",description:"Scanning beam"},fade:{category:"text",name:"Fade",description:"Fade in/out"},typewriter:{category:"text",name:"Typewriter",description:"Characters appear one by one"},bounce:{category:"text",name:"Bounce",description:"Text bounces back and forth"},sparkle:{category:"text",name:"Sparkle",description:"Random sparkle overlay"},rainbow:{category:"ambient",name:"Rainbow",description:"HSV rainbow gradient"},matrix:{category:"ambient",name:"Matrix",description:"Digital rain effect"},plasma:{category:"ambient",name:"Plasma",description:"Classic plasma waves"},gradient:{category:"ambient",name:"Gradient",description:"Moving color gradients"},fire:{category:"ambient",name:"Fire",description:"Fire/flame simulation"},water:{category:"ambient",name:"Water",description:"Ripple/wave effect"},stars:{category:"ambient",name:"Stars",description:"Twinkling starfield"},confetti:{category:"ambient",name:"Confetti",description:"Falling colored particles"},plasma_wave:{category:"ambient",name:"Plasma Wave",description:"Multi-frequency sine waves"},radial_pulse:{category:"ambient",name:"Radial Pulse",description:"Expanding ring patterns"},hypnotic:{category:"ambient",name:"Hypnotic",description:"Spiral pattern"},lava:{category:"ambient",name:"Lava",description:"Flowing lava/magma"},aurora:{category:"ambient",name:"Aurora",description:"Northern lights"},color_cycle:{category:"color",name:"Color Cycle",description:"Cycle through colors"},rainbow_text:{category:"color",name:"Rainbow Text",description:"Rainbow gradient on text"},neon:{category:"color",name:"Neon",description:"Pulsing neon glow"}},q=class{constructor(e){this.renderer=e,this.textEffects=new rt(e),this.ambientEffects=new lt(e),this.colorEffects=new ct(e),this.currentEffect="fixed",this.effectState={tick:0}}getEffectInfo(e){return M[e]||M.fixed}getEffectsByCategory(e){return Object.entries(M).filter(([,t])=>t.category===e).map(([t,s])=>({key:t,...s}))}initEffect(e,t={}){let s=this.getEffectInfo(e);switch(this.currentEffect=e,this.effectState={tick:0,...t},s.category){case"text":this.textEffects.init(e,this.effectState);break;case"ambient":this.ambientEffects.init(e,this.effectState);break;case"color":this.colorEffects.init(e,this.effectState);break}return this.effectState}step(){let e=this.getEffectInfo(this.currentEffect);switch(this.effectState.tick=(this.effectState.tick||0)+1,e.category){case"text":this.textEffects.step(this.currentEffect,this.effectState);break;case"ambient":this.ambientEffects.step(this.currentEffect,this.effectState);break;case"color":this.colorEffects.step(this.currentEffect,this.effectState);break}}render(e,t,s){switch(this.getEffectInfo(this.currentEffect).category){case"ambient":this.ambientEffects.render(this.currentEffect,this.effectState);break;case"text":this.textEffects.render(this.currentEffect,this.effectState,e,t,s);break;case"color":this.colorEffects.render(this.currentEffect,this.effectState,e);break}}isAmbient(e){return this.getEffectInfo(e).category==="ambient"}needsAnimation(e){return e!=="fixed"}},ye=Object.entries(M).filter(([,c])=>c.category==="text").map(([c])=>c),we=Object.entries(M).filter(([,c])=>c.category==="ambient").map(([c])=>c),Ee=Object.entries(M).filter(([,c])=>c.category==="color").map(([c])=>c),Se=Object.keys(M),N=class{constructor(e,t={}){this.container=e,this.width=t.width||64,this.height=t.height||16,this.pixelGap=t.pixelGap||.15,this.glowEnabled=t.glow!==!1,this.scale=t.scale||8,this.buffer=[],this._initBuffer(),this._colorPixels=[],this._extendedColorPixels=[],this.extendedWidth=this.width,this.effect="fixed",this.speed=50,this.animationId=null,this.lastFrameTime=0,this._isRunning=!1,this._canvas=null,this._ctx=null,this._imageData=null,this._glowCanvas=null,this._glowCtx=null,this._wrapper=null,this._canvasCreated=!1,this._pixelTemplate=null,this.effectManager=new q(this)}_initBuffer(){this.buffer=[];for(let e=0;e<this.width*this.height;e++)this.buffer.push([0,0,0])}_createCanvas(){if(typeof document>"u")return;let e=this.width*this.scale,t=this.height*this.scale;this._wrapper=document.createElement("div"),this._wrapper.style.cssText=`
        ...
        <div class="card-content">
          ...
          <div class="subsection">
            ...
            <div class="screen-grid" style="margin-bottom: 12px;">
              ${[1,2,3,4,5,6,7,8,9].map(i=>{let o=this._getSavedSlot(i);return`<button class="screen-btn${o?" saved":""}" data-screen="${i}" title="${o?o.name:"Empty"}">${i}${o?"*":""}</button>`}).join("")}
            </div>
    ...
    `}_buildAmbientEffectOptions(){return Object.entries(M).filter(([e,t])=>t.category===X.AMBIENT).map(([e,t])=>`<option value="${e}">${t.name}</option>`).join("")}_buildAmbientGrid(){let e=this._selectedAmbient||"rainbow";return Object.entries(M).filter(([t,s])=>s.category===X.AMBIENT).map(([t,s])=>`
