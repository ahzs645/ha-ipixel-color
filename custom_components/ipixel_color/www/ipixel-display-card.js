...
`;var _={A:[124,18,17,18,124],B:[127,73,73,73,54],C:[62,65,65,65,34],D:[127,65,65,34,28],E:[127,73,73,73,65],F:[127,9,9,9,1],G:[62,65,73,73,122],H:[127,8,8,8,127],I:[0,65,127,65,0],J:[32,64,65,63,1],K:[127,8,20,34,65],L:[127,64,64,64,64],M:[127,2,12,2,127],N:[127,4,8,16,127],O:[62,65,65,65,62],P:[127,9,9,9,6],Q:[62,65,81,33,94],R:[127,9,25,41,70],S:[70,73,73,73,49],T:[1,1,127,1,1],U:[63,64,64,64,63],V:[31,32,64,32,31],W:[63,64,56,64,63],X:[99,20,8,20,99],Y:[7,8,112,8,7],Z:[97,81,73,69,67],a:[32,84,84,84,120],b:[127,72,68,68,56],c:[56,68,68,68,32],d:[56,68,68,72,127],e:[56,84,84,84,24],f:[8,126,9,1,2],g:[12,82,82,82,62],h:[127,8,4,4,120],i:[0,68,125,64,0],j:[32,64,68,61,0],k:[127,16,40,68,0],l:[0,65,127,64,0],m:[124,4,24,4,120],n:[124,8,4,4,120],o:[56,68,68,68,56],p:[124,20,20,20,8],q:[8,20,20,24,124],r:[124,8,4,4,8],s:[72,84,84,84,32],t:[4,63,68,64,32],u:[60,64,64,32,124],v:[28,32,64,32,28],w:[60,64,48,64,60],x:[68,40,16,40,68],y:[12,80,80,80,60],z:[68,100,84,76,68],0:[62,81,73,69,62],1:[0,66,127,64,0],2:[66,97,81,73,70],3:[33,65,69,75,49],4:[24,20,18,127,16],5:[39,69,69,69,57],6:[60,74,73,73,48],7:[1,113,9,5,3],8:[54,73,73,73,54],9:[6,73,73,41,30]," ":[0,0,0,0,0],".":[0,96,96,0,0],",":[0,128,96,0,0],":":[0,54,54,0,0],";":[0,128,54,0,0],"!":[0,0,95,0,0],"?":[2,1,81,9,6],"-":[8,8,8,8,8],"+":[8,8,62,8,8],"=":[20,20,20,20,20],_:[64,64,64,64,64],"/":[32,16,8,4,2],"\\":[2,4,8,16,32],"(":[0,28,34,65,0],")":[0,65,34,28,0],"[":[0,127,65,65,0],"]":[0,65,65,127,0],"<":[8,20,34,65,0],">":[0,65,34,20,8],"*":[20,8,62,8,20],"#":[20,127,20,127,20],"@":[62,65,93,85,30],"&":[54,73,85,34,80],"%":[35,19,8,100,98],$:[18,42,127,42,36],"'":[0,0,7,0,0],'"':[0,7,0,7,0],"`":[0,1,2,0,0],"^":[4,2,1,2,4],"~":[8,4,8,16,8]};function E(x,e,t,i="#ff6600",s="#111"){let o=[],l=Math.floor((t-7)/2);for(let a=0;a<t;a++)for(let p=0;p<e;p++)o.push(s);let d=x.length*6-1,h=Math.max(1,Math.floor((e-d)/2));for(let a of x){let p=_[a]||_[" "];for(let u=0;u<5;u++)for(let f=0;f<7;f++){let v=p[u]>>f&1,b=h+u,y=l+f;b>=0&&b<e&&y<t&&y>=0&&(o[y*e+b]=v?i:s)}h+=6}return o}function $(x,e,t,i="#ff6600",s="#111"){let n=Math.floor((t-7)/2),l=x.length*6,d=e+l+e,c=[];for(let a=0;a<t;a++)for(let p=0;p<d;p++)c.push(s);let h=e;for(let a of x){let p=_[a]||_[" "];for(let u=0;u<5;u++)for(let f=0;f<7;f++){let v=p[u]>>f&1,b=h+u,y=n+f;b>=0&&b<d&&y<t&&y>=0&&(c[y*d+b]=v?i:s)}h+=6}return{pixels:c,width:d}}function D(x,e,t){let i,s,o,r=Math.floor(x*6),n=x*6-r,l=t*(1-e),d=t*(1-n*e),c=t*(1-(1-n)*e);switch(r%6){case 0:i=t,s=c,o=l;break;case 1:i=d,s=t,o=l;break;case 2:i=l,s=t,o=c;break;case 3:i=l,s=d,o=t;break;case 4:i=c,s=l,o=t;break;case 5:i=t,s=l,o=d;break}return[i*255,s*255,o*255]}var S=class{constructor(e,t={}){this.container=e,this.width=t.width||64,this.height=t.height||16,this.pixelGap=t.pixelGap||.1,this.buffer=[],this.prevBuffer=[],this._initBuffer(),this.extendedPixels=[],this.extendedWidth=this.width,this.offset=0,this.effect="fixed",this.speed=50,this.animationId=null,this.lastFrameTime=0,this.effectState={},this.pixelElements=[],this.svgCreated=!1}_initBuffer(){this.buffer=[],this.prevBuffer=[];for(let e=0;e<this.width*this.height;e++)this.buffer.push([0,0,0]),this.prevBuffer.push([-1,-1,-1])}_createSvg(){let t=100/this.width,i=t,s=this.height*i,o=this.pixelGap,r=document.createElementNS("http://www.w3.org/2000/svg","svg");r.setAttribute("viewBox",`0 0 100 ${s}`),r.setAttribute("preserveAspectRatio","xMidYMid meet"),r.style.width="100%",r.style.height="100%",r.style.display="block",this.pixelElements=[];for(let n=0;n<this.height;n++)for(let l=0;l<this.width;l++){let d=document.createElementNS("http://www.w3.org/2000/svg","rect");d.setAttribute("x",l*t),d.setAttribute("y",n*i),d.setAttribute("width",t-o),d.setAttribute("height",i-o),d.setAttribute("rx","0.3"),d.setAttribute("fill","rgb(17, 17, 17)"),r.appendChild(d),this.pixelElements.push(d)}this.container.innerHTML="",this.container.appendChild(r),this.svgCreated=!0}setPixel(e,t,i){if(e>=0&&e<this.width&&t>=0&&t<this.height){let s=t*this.width+e;this.buffer[s]=i}}clear(){for(let e=0;e<this.buffer.length;e++)this.buffer[e]=[0,0,0]}flush(){this.svgCreated||this._createSvg();for(let e=0;e<this.buffer.length;e++){let[t,i,s]=this.buffer[e],[o,r,n]=this.prevBuffer[e];if(t!==o||i!==r||s!==n){let l=this.pixelElements[e];if(l){let d=t>20||i>20||s>20;l.setAttribute("fill",`rgb(${Math.round(t)}, ${Math.round(i)}, ${Math.round(s)})`),d?l.style.filter=`drop-shadow(0 0 2px rgb(${t}, ${i}, ${s}))`:l.style.filter=""}this.prevBuffer[e]=[t,i,s]}}}setData(e,t=null,i=null){this._colorPixels=e,t?(this._extendedColorPixels=t,this.extendedWidth=i||this.width):(this._extendedColorPixels=e,this.extendedWidth=this.width)}_hexToRgb(e){if(!e||e==="#111"||e==="#000")return[17,17,17];if(e==="#050505")return[5,5,5];let t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return t?[parseInt(t[1],16),parseInt(t[2],16),parseInt(t[3],16)]:[17,17,17]}setEffect(e,t=50){if(this.effect=e,this.speed=t,this.offset=0,this.effectState={},e==="snow"||e==="breeze"){this.effectState.phases=[];for(let i=0;i<this.width*this.height;i++)this.effectState.phases[i]=Math.random()*Math.PI*2}if(e==="blink"&&(this.effectState.visible=!0),e==="rainbow"&&(this.effectState.position=0),e==="matrix"){let i=[[0,255,0],[0,255,255],[255,0,255]];this.effectState.colorMode=i[Math.floor(Math.random()*i.length)],this.effectState.buffer=[];for(let s=0;s<this.height;s++){let o=[];for(let r=0;r<this.width;r++)o.push([0,0,0]);this.effectState.buffer.push(o)}}e==="plasma"&&(this.effectState.time=0),e==="gradient"&&(this.effectState.time=0)}start(){this.animationId||(this.lastFrameTime=performance.now(),this._animate())}stop(){this.animationId&&(cancelAnimationFrame(this.animationId),this.animationId=null)}_animate(){let e=performance.now(),t=500-(this.speed-1)*4.7;e-this.lastFrameTime>=t&&(this.lastFrameTime=e,this._step()),this._renderFrame(),this.animationId=requestAnimationFrame(()=>this._animate())}_step(){this.effect==="scroll_ltr"?(this.offset-=1,this.offset<=-this.extendedWidth&&(this.offset=this.width)):this.effect==="scroll_rtl"?(this.offset+=1,this.offset>=this.extendedWidth&&(this.offset=-this.width)):this.effect==="blink"?this.effectState.visible=!this.effectState.visible:this.effect==="snow"||this.effect==="breeze"||this.effect==="laser"?this.effectState.tick=(this.effectState.tick||0)+1:this.effect==="rainbow"?this.effectState.position=(this.effectState.position+.01)%1:this.effect==="matrix"?this._stepMatrix():(this.effect==="plasma"||this.effect==="gradient")&&(this.effectState.time=(this.effectState.time||0)+.05)}_stepMatrix(){let e=this.effectState.buffer,t=this.effectState.colorMode,i=.15;e.pop();let s=e[0].map(([o,r,n])=>[o*(1-i),r*(1-i),n*(1-i)]);e.unshift(JSON.parse(JSON.stringify(s)));for(let o=0;o<this.width;o++)Math.random()<.08&&(e[0][o]=[Math.floor(Math.random()*t[0]),Math.floor(Math.random()*t[1]),Math.floor(Math.random()*t[2])])}_renderFrame(){if(this.effect==="rainbow"){this._renderRainbow(),this.flush();return}if(this.effect==="matrix"){this._renderMatrix(),this.flush();return}if(this.effect==="plasma"){this._renderPlasma(),this.flush();return}if(this.effect==="gradient"){this._renderGradient(),this.flush();return}let e=this._extendedColorPixels||this._colorPixels||[],t=this._colorPixels||[];for(let i=0;i<this.height;i++)for(let s=0;s<this.width;s++){let o;if(this.effect==="scroll_ltr"||this.effect==="scroll_rtl"){let c=s-this.offset;for(;c<0;)c+=this.extendedWidth;for(;c>=this.extendedWidth;)c-=this.extendedWidth;o=e[i*this.extendedWidth+c]||"#111"}else o=t[i*this.width+s]||"#111";let[r,n,l]=this._hexToRgb(o);if(r>20||n>20||l>20){if(this.effect==="blink")this.effectState.visible||(r=n=l=17);else if(this.effect==="snow"){let c=this.effectState.phases?.[i*this.width+s]||0,h=this.effectState.tick||0,a=.3+.7*Math.abs(Math.sin(c+h*.3));r*=a,n*=a,l*=a}else if(this.effect==="breeze"){let c=this.effectState.phases?.[i*this.width+s]||0,h=this.effectState.tick||0,a=.4+.6*Math.abs(Math.sin(c+h*.15+s*.2));r*=a,n*=a,l*=a}else if(this.effect==="laser"){let a=((this.effectState.tick||0)+s)%this.width<3?1:.3;r*=a,n*=a,l*=a}}this.setPixel(s,i,[r,n,l])}this.flush()}_renderRainbow(){let e=this.effectState.position||0;for(let t=0;t<this.width;t++){let i=(e+t/this.width)%1,[s,o,r]=D(i,1,.6);for(let n=0;n<this.height;n++)this.setPixel(t,n,[s,o,r])}}_renderMatrix(){let e=this.effectState.buffer;if(e)for(let t=0;t<this.height;t++)for(let i=0;i<this.width;i++){let[s,o,r]=e[t][i];this.setPixel(i,t,[s,o,r])}}_renderPlasma(){let e=this.effectState.time||0,t=this.width/2,i=this.height/2;for(let s=0;s<this.width;s++)for(let o=0;o<this.height;o++){let r=s-t,n=o-i,l=Math.sqrt(r*r+n*n),d=Math.sin(s/8+e),c=Math.sin(o/6+e*.8),h=Math.sin(l/6-e*1.2),a=Math.sin((s+o)/10+e*.5),p=(d+c+h+a+4)/8,u=Math.sin(p*Math.PI*2)*.5+.5,f=Math.sin(p*Math.PI*2+2)*.5+.5,v=Math.sin(p*Math.PI*2+4)*.5+.5;this.setPixel(s,o,[u*255,f*255,v*255])}}_renderGradient(){let t=(this.effectState.time||0)*10;for(let i=0;i<this.width;i++)for(let s=0;s<this.height;s++){let o=(Math.sin((i+t)*.05)*.5+.5)*255,r=(Math.cos((s+t)*.05)*.5+.5)*255,n=(Math.sin((i+s+t)*.03)*.5+.5)*255;this.setPixel(i,s,[o,r,n])}}renderStatic(){this.svgCreated||this._createSvg(),this._renderFrame()}setDimensions(e,t){(e!==this.width||t!==this.height)&&(this.width=e,this.height=t,this._initBuffer(),this.svgCreated=!1)}};function F(x,e,t,i=1){let o=100/x,r=o,n=e*r,l=i*.1,d="";for(let c=0;c<e;c++)for(let h=0;h<x;h++){let a=t[c*x+h]||"#111",u=a!=="#111"&&a!=="#000"&&a!=="#1a1a1a"&&a!=="#050505"?`filter:drop-shadow(0 0 2px ${a});`:"";d+=`<rect x="${h*o}" y="${c*r}" width="${o-l}" height="${r-l}" fill="${a}" rx="0.3" style="${u}"/>`}return`
    <svg viewBox="0 0 100 ${n}" preserveAspectRatio="xMidYMid meet" style="width:100%;height:100%;display:block;">
      ${d}
    </svg>`}var A="iPIXEL_DisplayState",T={text:"",mode:"text",effect:"fixed",speed:50,fgColor:"#ff6600",bgColor:"#000000",lastUpdate:0};function X(){try{let x=localStorage.getItem(A);if(x)return JSON.parse(x)}catch(x){console.warn("iPIXEL: Could not load saved state",x)}return{...T}}function H(x){try{localStorage.setItem(A,JSON.stringify(x))}catch(e){console.warn("iPIXEL: Could not save state",e)}}window.iPIXELDisplayState||(window.iPIXELDisplayState=X());function B(){return window.iPIXELDisplayState}function w(x){return window.iPIXELDisplayState={...window.iPIXELDisplayState,...x,lastUpdate:Date.now()},H(window.iPIXELDisplayState),window.dispatchEvent(new CustomEvent("ipixel-display-update",{detail:window.iPIXELDisplayState})),window.iPIXELDisplayState}var C=class extends g{constructor(){super(),this._renderer=null,this._displayContainer=null,this._lastState=null,this._handleDisplayUpdate=e=>{this._updateDisplay(e.detail)},window.addEventListener("ipixel-display-update",this._handleDisplayUpdate)}disconnectedCallback(){window.removeEventListener("ipixel-display-update",this._handleDisplayUpdate),this._renderer&&(this._renderer.stop(),this._renderer=null)}_updateDisplay(e){if(!this._renderer||!this._displayContainer)return;let[t,i]=this.getResolution();if(!this.isOn()){this._renderer.stop();let f=E("",t,i,"#111","#050505");this._displayContainer.innerHTML=F(t,i,f);return}let o=e?.text||"",r=e?.effect||"fixed",n=e?.speed||50,l=e?.fgColor||"#ff6600",d=e?.bgColor||"#111",c=e?.mode||"text",h=o,a=l;c==="clock"?(h=new Date().toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!1}),a="#00ff88"):c==="gif"?(h="GIF",a="#ff44ff"):c==="rhythm"&&(h="***",a="#44aaff"),(this._renderer.width!==t||this._renderer.height!==i)&&(this._renderer.width=t,this._renderer.height=i);let p=h.length*6;if((r==="scroll_ltr"||r==="scroll_rtl")&&p>t){let{pixels:f,width:v}=$(h,t,i,a,d),b=E(h,t,i,a,d);this._renderer.setData(b,f,v)}else{let f=E(h,t,i,a,d);this._renderer.setData(f)}this._renderer.setEffect(r,n),r==="fixed"?(this._renderer.stop(),this._renderer.renderStatic()):this._renderer.start()}render(){if(!this._hass)return;let[e,t]=this.getResolution(),i=this.isOn(),s=this._config.name||this.getEntity()?.attributes?.friendly_name||"iPIXEL Display",o=B(),n=this.getEntity()?.state||"",d=this.getRelatedEntity("select","_mode")?.state||o.mode||"text",c=o.text||n,h=o.effect||"fixed",a=o.speed||50,p=o.fgColor||"#ff6600",u=o.bgColor||"#111";this.shadowRoot.innerHTML=`
      <style>${m}
